...
# my_fw=Firewall_Handler("NOTIFICATIONS.log",last_checked_file)
# #my_fw.aply_rules_from_file("/home/rochelly/roxFirewallman/em_classes/services-rules-files/biologia.fw",'ROX')
